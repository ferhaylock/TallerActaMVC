...
<html>
	...
	<body>
	<form class="form" action="./Vista/router.php?controller=Login&action=login" method="POST" autocomplete="off">
	<?php
		 isset($vali) ? $vali->resultBlock($errors) : '';
		?>
	<h2 class="form__title">Inicia Sesión</h2>
        <p class="form__paragraph">Crea tu cuenta aqui: <a href="./Vista/router.php?controller=Registro&action=validaciones" class="form__link">Entra aquí</a></p>
        ...
        <div class="form__container">
			...
			<p class="form__paragraph">Recuperar contraseña: <a href="./Vista/recuperacion.php" class="form__link">Aqui</a></p>
        </div>
